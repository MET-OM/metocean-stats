...
LocationX = "Stavern"
lon = [3, 35] # endre manuelt fra område (lengegrad)
lat = [60, 40] # breddegrad
label = ['NORA3'] # dataset
...
# ________________FRONTPAGE______________
...
# __________TEXT CONTENT_____________
...
# Legg til figur 4.14
add_image_with_caption(doc, 'T2m_monthly_extremes_neg.png', f"Figure 4.14: Monthly minimum, mean and maximum air temperature at the {LocationX} field.", orientation="portrait")
doc.add_paragraph() 
...
# Legg til figur 4.15
add_image_with_caption(doc, 'T2m_monthly_extremes_pos.png', f"Figure 4.15: Monthly distribution of extreme negative air temperature with return period 1, 10 and 100 years (annual probability of"
...
# Legg til figur 4.16
add_image_with_caption(doc, 'T2m_monthly_stats.png', f"Figure 4.16: Monthly distribution of extreme positive air temperature with return period 1, 10 and 100 years (annual probability of"
f"exceedance 0.63, 10 -1 and 10-2) for the {LocationX} field.", orientation="portrait")
doc.add_paragraph()  
...
"\n\nThe relationship between significant wave height for a given wind speed, denoted HS(U), is modelled by the"
...
#----- SAVE AND OPEN ----
# Save the document
output_filename = 'metocean-report.docx'
