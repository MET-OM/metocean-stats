...
#general_stats.table_var_sorted_by_hs(data=ds.data, var='pp1d', output_file='tp_sorted_by_hs.csv')
...
rl_pot = extreme_stats.return_levels_pot(data=ds.data, var='swh', periods=[20,50,100,1000], output_file='return_levels_POT.pdf')
rl_am = extreme_stats.return_levels_annual_max(data=ds.data, var='swh', periods=[20,50,100,1000],method='GEV',output_file='return_levels_GEV.pdf')
