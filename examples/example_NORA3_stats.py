...
#tables.table_monthly_return_periods(ds,var='HS',periods=[1, 10, 100, 10000],distribution='Weibull', units='m',output_file='monthly_extremes_weibull.csv')
...
plots.plot_monthly_return_periods(ds,var='T2m',periods=[1, 10, 100],distribution='GUM_L',negative=True, units='°C',output_file='T2m_monthly_extremes_neg.png')
#plots.plot_monthly_return_periods(ds,var='T2m',periods=[1, 10, 100],distribution='GUM', units='°C',output_file='T2m_monthly_extremes_pos.png')
tables.table_monthly_return_periods(ds,var='T2m',periods=[1, 10, 100],distribution='GUM_L',negative=True, units='°C',output_file='T2m_monthly_extremes_neg.csv')
