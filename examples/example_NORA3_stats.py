...
ds = ts.TimeSeries(lon=1.320, lat=53.324,start_time='2000-01-01', end_time='2021-03-31' , product='NORA3_wave_sub')
...
rl = extreme_stats.return_levels_pot(data=ds.data, var='hs', periods=100)
print(rl)
