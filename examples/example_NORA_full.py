...
#df = pd.concat([df_ref, df_comp], axis=1)
...
#tables.table_binned_error_metric(dff=[df_ref,df_comp],var_bin = 'HS', var_ref='TP',var_comp='TP', var_bin_size=1,threshold_min=100, error_metric=['rmse','bias','mae','corr','si'],output_file='binned_error_metric.csv')
#plots.plot_binned_error_metric(dff=[df_ref,df_comp],var_bin = 'HS',var_bin_unit='m', var_ref='TP',var_comp='TP',var_comp_unit='s', var_bin_size=0.5,threshold_min=100, plot_y='bias',title='Example title',output_file='plot_binned_error_metric.png')
...
# tables.scatter_diagram(df, var1='HS', step_var1=1, var2='TP', step_var2=1, output_file= str('Hs_Tp_scatter.csv'))
...
# tables.table_directional_joint_distribution_Hs_Tp_return_values(df,var_hs='HS',var_tp='TP',var_dir='DIRM',periods=[1,10,100,1000],adjustment='NORSOK',output_file=str('directional_Hs_Tp_joint_return_values.csv'))
...
# tables.table_hs_for_given_wind(df, 'HS','W10', bin_width=2, max_wind=42, output_file= str('table_perc_hs_for_wind.csv'))
...
# plots.plot_multi_joint_distribution_Hs_Tp_var3(df,var_hs='HS',var_tp='TP',var3='W10',var3_units='m/s',periods=[100],var3_bin=5,threshold_min=100,output_file='Hs.Tp.joint.distribution.multi.binned.var3.png')
