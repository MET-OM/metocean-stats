...
#Option 3:
var_ref = ['HS','HS.2','HS.1']
var_comp = ['TP','W10','HS.2']

plots.taylor_diagram(df,var_ref,var_comp,norm_std=True,output_file=folder /'Testing_Taylor'/ 'Taylor_diagram.png')
#############
